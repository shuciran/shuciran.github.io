...
![[Pasted image 20230128184507.png]]Enumerating the web server with openssl since it has the port 443 active we find a subdomain on the Common Name of the certificate:
```bash
...
![[Pasted image 20230129031922.png]]
