...
You can often detect blind XXE triggering the out-of-band network interaction to a system that you control. For example, you would define an external entity as follows[^xxe-external-entities]:
```xml
