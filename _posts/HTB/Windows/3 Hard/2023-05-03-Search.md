...
Running dirsearch reveals the existence of a more web directories.
...
```
As we can see after uploading the output to our Bloodhound, there is a `ReadGMSAPassword` attribute for this user:
