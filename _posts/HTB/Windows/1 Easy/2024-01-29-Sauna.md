...
description: >-
  Sauna HTB Machine
title: Sauna (Easy)                # Add title here
...
tags: [hackthebox, rpc enumeration, web enumeration, asreproast, hashcat, krbtgt5]     # TAG names should always be lowercase; replace template with writeup, and add relevant tags
show_image_post: true                                    # Change this to true
image: /assets/img/icons/Sauna.png                # Add infocard image here for post preview image
---
##### Host entries
```bash
