...
description: >-
  Forest HTB Machine
title: Forest (Easy)                # Add title here
date: 2024-01-29 08:00:00 -0600                           # Change the date to match completion date
categories: [HackTheBox, Windows - Easy]                     # Change Templates to Writeup
tags: [hackthebox, rpc enumeration, asreproast, kerbrute, kerberos enumeration, impacket-getNPUsers, sharphound, bloodhound, dcsync attack, writedacl]     # TAG names should always be lowercase; replace template with writeup, and add relevant tags
show_image_post: true                                    # Change this to true
image: /assets/img/icons/Forest.png                # Add infocard image here for post preview image
---
##### Host entries
```bash
...
Guest:501:aad3b435b51404eeaad3b435b51404ee:31d6cfe0d16ae931b73c59d7e0c08 p b  0:::
