...
tags: [hackthebox, smb enumeration, mssql, server procedures, certify.exe, adcs.ps1, rubeus.exe, gci]     # TAG names should always be lowercase; replace template with writeup, and add relevant tags
...
- PowerView.ps1
- Extraction of vulnerable certificate templates [Certify.exe]
